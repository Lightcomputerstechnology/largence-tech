  ...
  return (
    <div className="mx-auto max-w-md space-y-4">
      ...
      <form className="space-y-3" onSubmit={onSubmit}>
        ...
        <button className="w-full rounded-xl bg-[var(--primary)] text-white py-2">Create account</button>
      </form>
      {msg && <p className="text-sm text-neutral-600">{msg}</p>}
      <p className="text-sm">Already have an account? <a href="/sign-in">Sign in</a></p>
    </div>
  );
}
