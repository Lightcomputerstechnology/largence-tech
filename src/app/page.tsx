    ...
    <section className="grid gap-8 md:grid-cols-2 items-center">
      <div className="space-y-5">
        <h1 className="text-4xl md:text-5xl font-bold leading-tight">
          Draft Custom Legal Docs in Minutes.
        </h1>
        ...
        <div className="flex gap-3">
          <a
            className="rounded-xl bg-[var(--primary)] px-5 py-3 text-white"
            href="/sign-up"
          >
            Get Started Free
          </a>
        ...
        <p className="text-sm text-neutral-600">
          3 free documents each month. No credit card required.
        </p>
      </div>
      ...
      <div className="rounded-xl border p-6 bg-[var(--ring)]/40 text-sm text-neutral-700">
        ...
        It’s styled with our default brand red accents and tidy formatting.
      </div>
    </section>
  );
}
